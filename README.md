# heif-parse [![CI](https://img.shields.io/github/actions/workflow/status/felixbuenemann/heif-parse/ci.yml?style=flat-square&label=CI)](https://github.com/felixbuenemann/heif-parse/actions/workflows/ci.yml) [![crates.io](https://img.shields.io/crates/v/heif-parse?style=flat-square)](https://crates.io/crates/heif-parse) [![lib.rs](https://img.shields.io/crates/v/heif-parse?style=flat-square&label=lib.rs&color=blue)](https://lib.rs/crates/heif-parse) [![docs.rs](https://img.shields.io/docsrs/heif-parse?style=flat-square)](https://docs.rs/heif-parse) [![MSRV](https://img.shields.io/badge/MSRV-1.93-blue?style=flat-square)](https://doc.rust-lang.org/cargo/reference/manifest.html#the-rust-version-field) [![license](https://img.shields.io/crates/l/heif-parse?style=flat-square)](#license)
